...
import xyz.alphaline.mintablenew.cell.XxisEndView
import xyz.alphaline.mintablenew.cell.XxisView
import xyz.alphaline.mintablenew.cell.ZeroPointView
import xyz.alphaline.mintablenew.model.ScheduleEntity
import xyz.alphaline.mintablenew.schedule.ScheduleView
...
import xyz.alphaline.mintablenew.utils.getWindowWidth
...
class MinTimeTableView : BaseTimeTable {
    ...
    fun initTable(dayList: Array<String>) {
        ...
        xyz.alphaline.mintablenew.utils.removeViews(
            arrayOf(
                zeroPoint,
                topMenu,
                timeCell,
